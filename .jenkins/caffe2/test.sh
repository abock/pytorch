...
if [[ "$BUILD_ENVIRONMENT" == *onnx* ]]; then
  ...
  pip install -q --user ninja flatbuffers==2.0 numpy==1.21.6 beartype==0.10.4
  pip install -q --user -i https://test.pypi.org/simple/ ort-nightly==1.13.0.dev20221005006
